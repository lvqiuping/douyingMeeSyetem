  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" type="danger" icon="el-icon-edit" @click="handleBatchDeleted">
       ...
       <el-button class="filter-item" style="margin-left: 10px;" type="danger" icon="el-icon-edit" @click="filterColumns===true">
       筛选列
      </el-button>
       <el-select v-model="filterColumns" placeholder="Imp" clearable style="width: 90px" class="filter-item">
        <el-option>
           <el-checkbox-group v-model="checkboxVal">
        <el-checkbox label="author">
          author
        </el-checkbox>
        <el-checkbox label="pageviews">
          pageviews
        </el-checkbox>
      </el-checkbox-group>
        </el-option>
...
const defaultFormThead = ['pageviews']
export default {
  name: 'ComplexTable',
