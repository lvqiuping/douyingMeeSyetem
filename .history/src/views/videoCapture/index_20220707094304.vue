<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="margin-left:50px;">
        ...
        <el-form-item label="评论屏蔽关键词">
          ...
          <div>系统推荐屏蔽关键词<span style="font-size: 12px; color: rgb(186,171,173)">（选择屏蔽关键词快速添加到词库）</span></div>
        </el-form-item>
