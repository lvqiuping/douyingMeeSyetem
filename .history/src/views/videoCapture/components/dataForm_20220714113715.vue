  ...
  <div>
    <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="margin-left:50px;margin-right:50px;">
      ...
      <el-form-item label="搜索排序" prop="SortBy">
        <el-radio v-model="temp.SortBy" label="1">默认排序</el-radio>
        <el-radio v-model="temp.SortBy" label="2">最多点赞</el-radio>
        <el-radio v-model="temp.SortBy" label="3">最新发布</el-radio>
      </el-form-item>
      <el-form-item label="发布时间" prop="PublishFromNowDay">
        <el-radio v-model="temp.PublishFromNowDay" label="1">默认</el-radio>
        <el-radio v-model="temp.PublishFromNowDay" label="2">3天内</el-radio>
        <el-radio v-model="temp.PublishFromNowDay" label="3">一周内</el-radio>
        <el-radio v-model="temp.PublishFromNowDay" label="4">15天内</el-radio>
        <el-radio v-model="temp.PublishFromNowDay" label="5">一个月内</el-radio>
        <el-radio v-model="temp.PublishFromNowDay" label="6">半年内</el-radio>
      </el-form-item>
