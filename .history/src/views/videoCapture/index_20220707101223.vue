    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="width: 600px; margin-left:50px;">
        ...
        <el-form-item label="视频标题再筛选">
          ...
          <span style="font-size: 12px; color: #ccc">（该功能慎用，）</span>
        </el-form-item>

        <el-form-item label="搜索排序" prop="type">
          <el-radio v-model="searchSort" label="1">默认排序</el-radio>
          <el-radio v-model="searchSort" label="2">最多点赞</el-radio>
          <el-radio v-model="searchSort" label="3">最新发布</el-radio>
        </el-form-item>
        <el-form-item label="发布时间" prop="type">
          <el-radio v-model="publicTime" label="1">默认</el-radio>
          <el-radio v-model="publicTime" label="2">3天内</el-radio>
          <el-radio v-model="publicTime" label="3">一周内</el-radio>
          <el-radio v-model="publicTime" label="1">15天内</el-radio>
          <el-radio v-model="publicTime" label="2">一个月内</el-radio>
          <el-radio v-model="publicTime" label="3">半年内</el-radio>
        </el-form-item>
        ...
        <el-form-item label="定时监控频率" prop="type">
          <span>每</span><el-input-number v-model="num" :min="0" @change="handleChange" /><span>天运行一次</span>
          <div style="font-size: 12px; color: #ccc">（默认为0，不开启自动监控）</div>
        </el-form-item>
        <el-form-item label="最长监控天数" prop="type">
          <span>持续监控</span><el-input-number v-model="num" :min="0" @change="handleChange" /><span>天后停止</span>
          <div style="font-size: 12px; color: #ccc">（默认为0，不开启自动监控）</div>
        </el-form-item>
