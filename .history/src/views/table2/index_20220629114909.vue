...
<script>
import BasicTable from '@/views/common/tables/BasicTable.vue'
import TableOperation from '@/views/common/tables/TableOperation'
...
export default {
  name: 'ComplexTable',
  components: { BasicTable, TableOperation },
  // directives: { waves },
  filters: {
    statusFilter(status) {
      const statusMap = {
