<template>
  <div>
    <el-form ref="searchForm" :rules="rules" :model="temp" label-position="left" label-width="110px" style="margin-left:50px;margin-right:50px;">
      <el-form-item v-show="searchVideoCapture" label="任务名" prop="TaskName">
        <el-input v-model="temp.TaskName" placeholder="随意取一个名字吧" />
      </el-form-item>
      <el-form-item v-show="searchVideoCapture2" label="分析源" prop="TaskSource">
...
export default {
  ...
  props: {
    ...
    searchVideoCapture2: { type: Boolean, default: false }
  },
  data() {
    return {
      temp: {
